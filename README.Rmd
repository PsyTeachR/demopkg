...
To clone this package project to your computer, run the following code. Set `destdir` to the directory where you want to save this project directory (defaults to your current working directory). 
